...
;(function ($, Metis) {
  ...
  function lemniscatex(i) {
    return Math.sqrt(2) * Math.cos(i) / (Math.pow(Math.sin(i), 8) + 6);
  }

  function lemniscatey(i) {
    return Math.sqrt(2) * Math.cos(i) * Math.sin(i) / (Math.pow(Math.sin(i), 8) + 1);
  }
...
;(function ($) {
    ...
    Metis.dashboard = function () {
        ...
        $(".sparkline.line_day").sparkline([8, 6, 7, 9, 9, 5, 4, 6, 6, 4, 6, 7], {
            type: 'line',
            height: '40',
